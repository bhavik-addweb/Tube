<script src="dist_client/vendor/jquery/jquery.min.js"></script>
  ...
  <!-- Page level plugins -->
  <script src="<?php echo e(URL::asset('dist_client/vendor/chart.js/Chart.min.js')); ?>"></script>

  <!-- Page level custom scripts -->
  <script src="<?php echo e(URL::asset('dist_client/js/demo/chart-area-demo.js')); ?>"></script>
  <script src="<?php echo e(URL::asset('dist_client/js/demo/chart-pie-demo.js')); ?>"></script>
...
</script><?php /**PATH /var/www/Tube/resources/views/admin_assets/js.blade.php ENDPATH**/ ?>