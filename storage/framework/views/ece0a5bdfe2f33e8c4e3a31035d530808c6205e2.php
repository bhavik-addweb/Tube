		...
		<div class="modal fade" id="addplay" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
				...
				<form method="post" action="<?php echo e(route('myplaylist.store' )); ?>" >
						<?php echo csrf_field(); ?>
						<h5>Playlist Name</h5><select name="pid">
				<?php $__currentLoopData = $result2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $input): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<option class="option" value=" <?php echo e($input->id); ?>"><?php echo e($input->play_name); ?>.</option>
			...
			<input type="hidden" name="vid" value="<?php echo e($data->id); ?>">
							...
							<button type="submit" >Add to playlist</a></button>
						</form>
			  </div>
            </div>
          </div>
		...
		<div class="main-content">
			...
			<div class="clear"> </div>
				<div class="title">
					...
					<!-- shows count of likes and dislike -->
				...
				<div class="share-artical">
				  ...
				  <!-- comment form -->
				  					<h3>leave a comment</h3>
									   ...
									   <form method="post" action="<?php echo e(route('com.store' )); ?>" >
										<?php echo csrf_field(); ?>
										...
										<input type="text" class="textbox" value="<?php echo e(Auth::user()->name); ?>"disabled >
										<input type="text" class="textbox" value="<?php echo e(Auth::user()->email); ?>" disabled>
...
<?php /**PATH /var/www/Tube/resources/views/view.blade.php ENDPATH**/ ?>